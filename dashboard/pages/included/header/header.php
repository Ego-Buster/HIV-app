...
<div class="mobile-content-menu">
  ...
  <div class="item-menu mobile-item-menu"><i class="DGfi-file-excel icon-menu"></i><span class="txt-menu"> Documents</span></div>
...
<div class="content-menu">
  ...
  <div class="item-menu"><i class="DGfi-file-excel icon-menu"></i><span class="txt-menu"> Documents</span></div>
